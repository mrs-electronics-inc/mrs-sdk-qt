...
<Tabs syncKey="buildtool">
    <TabItem label="CMake">
        This step is only necessary for QMake-based projects. You can skip to the [next section](#run-sdk-build-system).
    ...
    <TabItem label="QMake">
        ...
        Follow [this guide](/get-started/set-up-build-kits#verify-kits) to verify your configuration.
    </TabItem>
</Tabs>
