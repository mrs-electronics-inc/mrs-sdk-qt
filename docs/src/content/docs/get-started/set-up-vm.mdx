---
title: Set Up the Virtual Machine
...
2. [**Obtain**](#obtain-the-vm-image) the VMDK image (download or build locally)
3. [**Import**](#import-the-vm) it into your virtualization platform
4. [**Launch**](#using-the-vm) the VM and start developing with Qt Creator
